		...
		curatedMainPageData: {
			curatedContent: {
				items: [
					{
						label: "Categories",
						imageUrl: "http:\/\/vignette2.wikia.nocookie.net\/mercurycc\/images\/3\/3e\/Burton-jane-ginger-domestic-kitten-felis-catus-rolling-on-back-playing.jpg\/revision\/latest?cb=20150706160548",
						type: "section",
						"items": [
							{
								label: "Articles label",
								imageUrl: "http:\/\/vignette1.wikia.nocookie.net\/mercurycc\/images\/5\/5a\/Red.jpg\/revision\/latest?cb=20150708092401",
								type: "category",
					...
					{
						label: "Broken",
						imageUrl: "http:\/\/vignette1.wikia.nocookie.net\/mercurycc\/images\/5\/57\/UC39.jpg\/revision\/latest?cb=20150715133441",
						type: "category",
