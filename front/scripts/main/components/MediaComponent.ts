...
App.MediaComponent.reopenClass({
	newFromMedia: function (media: ArticleMedia, isInfoboxHeroImage: boolean): typeof App.MediaComponent {
		if (media.context === 'infobox') {
			return App.InfoboxImageMediaComponent.create({isInfoboxHeroImage: isInfoboxHeroImage});
