...
export default App.WikiaInYourLangComponent = Ember.Component.extend(
	...
	LanguagesMixin,
	{
		...
		shouldShowWikiaInYourLang() {
			const value = window.localStorage.getItem(this.get('alertKey')),
				...
				isUserLangDifferentFromWikiLang = this.get('getBrowserLanguage') !== Ember.get(Mercury, 'wiki.language.content');
