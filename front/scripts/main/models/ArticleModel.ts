...
App.ArticleModel.reopenClass({
	...
	setArticle: function (model: typeof App.ArticleModel, source = this.getPreloadedData()) {
		...
		M.state('article.type', data.type);
