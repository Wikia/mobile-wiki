export default {
	data: {
		...
		details: {
			...
			thumbnail: "https://vignette.wikia.nocookie.net/agas/images/9/95/Harajuku_Girl.jpg/revision/latest/window-crop/width/200/x-offset/84/y-offset/0/window-width/335/window-height/334?cb=20140512132255",
			original_dimensions: {
				width: "500",
				height: "334"
			},
		...
		adsContext: {
			opts: {
				...
				pageType: "all_ads",
				showAds: true,
				pageFairDetectionUrl: "/load.php?cb=1521720057&debug=false&lang=en&modules=6704ffcaede8f70b2a9d20ace3b81d77&only=scripts&skin=wikiamobile&*",
				prebidBidderUrl: [
