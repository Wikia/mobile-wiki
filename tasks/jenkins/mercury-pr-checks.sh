...
testFront="gulp test-common && gulp test-auth && cd front/main && ember test --path ../../www/front/main -tp 7357"
$($testFront) 2>&1 | tee jenkins/front-tests.log || { error1=true && failJob=true; }
