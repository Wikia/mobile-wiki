...
export class ImageReviewRequestHelper {
    ...
    //                });
    //            } else {
    //                return Promise.reject(new ImageReviewDataRequestError({
    ...
    getImagesToReview(): void {

    }
}

export class ImageReviewDataRequestError {
    private data: any;
...
ImageReviewDataRequestError.prototype = Object.create(Error.prototype);
