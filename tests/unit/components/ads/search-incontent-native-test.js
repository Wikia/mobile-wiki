...
module('Unit | Component | ads | search incontent native', (hooks) => {
  setupTest(hooks);
  let adsModuleStub;
  ...
  hooks.beforeEach(function () {
    ...
    this.component = this.owner.factoryFor('component:ads/search-incontent-native')
      .create();
  });
  ...
  test('should render ad', function (assert) {
    ...
    setTimeout(() => {
      assert.ok(this.adSlotBuilder.injectSearchPageNative.calledOnceWith(this.component));
      done();
    });
  });
});
