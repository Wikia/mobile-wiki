...
module('Integration | Component | wikia search', function(hooks) {
  ...
  test('search displayed correctly with default settings', async function(assert) {
  ...
  test('search input has correct classes when inputFocused=true', async function(assert) {
      await render(hbs`
      {{wikia-search
          inputFocused=true
      }}`);
