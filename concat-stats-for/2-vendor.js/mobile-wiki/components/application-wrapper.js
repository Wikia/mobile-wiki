define('mobile-wiki/components/application-wrapper', ['exports', 'mobile-wiki/utils/article-link', 'mobile-wiki/utils/track-perf'], function (exports, _articleLink, _trackPerf) {
	'use strict';
