...
//TODO make amc ignore ad request timeout.
                ...
                OO.Ads.manager(function (_, $) {
                    ...
                    var GoogleIMA = function () {
                        ...
                        var _IMA_SDK_tryInitAdsManager = privateMember(function () {
                            ...
                            if (_IMAAdsManager && this.initialPlayRequested && !_IMAAdsManagerInitialized && _uiContainer) {
                                try {
                                    ...
                                    if (_usingAdRules && !this.hasPreroll &&
                        ...
                        var _trySetupAdsRequest = privateMember(function () {
                            ...
                            if (this.adsRequested || !this.canSetupAdsRequest || !this.adTagUrl || !this.uiRegistered || !_amc.currentEmbedCode || !_IMAAdsLoader || !_checkRequestAdsOnReplay()) {
                                return;
                            }
                                ...
                                if (slot.width && slot.height) {
                                    ...
                                    if (companionAd.length) {
                                        _.each(companionAd, function (ad) {
                                            companionAds.push({
                                                slotSize: slot.width + "x" + slot.height,
                                                ad: ad.getContent()
                                            });
                                        });
                                    }
            ...
            "../html5-common/js/utils/InitModules/InitOOUnderscore.js": 2,
            "../html5-common/js/utils/constants.js": 3,
            "../html5-common/js/utils/utils.js": 4
        }]
    }, {}, [6]);
}