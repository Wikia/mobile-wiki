define('mobile-wiki/utils/article-link', ['exports'], function (exports) {
	'use strict';

	Object.defineProperty(exports, "__esModule", {
		value: true
	});
	exports.default = getLinkInfo;
	exports.isHashLink = isHashLink;
	/**
  ...
  * @returns {LinkInfo}
  */
	function getLinkInfo(basePath, title, hash, uri, queryString) {
