define('mobile-wiki/utils/track', ['exports', 'mobile-wiki/modules/ads', 'mobile-wiki/modules/abtest'], function (exports, _ads, _abtest) {
	'use strict';

	Object.defineProperty(exports, "__esModule", {
		value: true
	});
	exports.trackActions = undefined;
	exports.track = track;
	exports.trackPageView = trackPageView;
	exports.trackExperiment = trackExperiment;
	exports.setTrackContext = setTrackContext;
  ...
  */
	function track(params) {
		var trackingMethod = params.trackingMethod || 'both',
		...
		if (typeof FastBoot !== 'undefined' || M.getFromShoebox('runtimeConfig.noExternals') || M.getFromShoebox('serverError')) {
			return;
		}
  ...
  * @returns {void}
  */
	function trackPageView(isInitialPageView, uaDimensions) {
		...
		if (enableTracking) {
			_ads.default.getInstance().trackKruxPageView();
		}
	}
  ...
  * @returns {void}
  */
	function trackExperiment(experiment, params) {
		var group = (0, _abtest.getGroup)(experiment) || 'CONTROL';
