...
You may want to add a new i18n file that creates a new translations namespace. To load the file add its name of the file to [localSettings.base.js](https://github.com/Wikia/mercury/blob/dev/server/config/localSettings.base.js#L291).
